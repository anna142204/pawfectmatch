    ...
    try {
        ...
        if (!res.ok) {
            ...
            if (res.status === 400 && data.animalsCount > 0) {
                throw new Error(`Impossible : Vous avez encore ${data.animalsCount} animaux. Supprimez-les d'abord.`);
            }
        ...
        <form v-else @submit.prevent="submitForm" class="form-content">
            ...
            <div class="section">
                ...
                <div class="form-group mb-4">
                    <label class="label">Nom de la société (Optionnel)</label>
                    <div class="input-wrapper"><Input v-model="form.societyName" placeholder="Refuge des..." /></div>
                </div>
                <div class="row">
                ...
                <div class="form-group mt-large">
                    ...
                    <div class="input-wrapper"><Input v-model="form.email" disabled class="disabled-input" /></div>
                </div>
            </div>

            <div class="section">
                <h3 class="text-h4 text-neutral-800 mb-4">Adresse</h3>
                <div class="row">
                    <div class="col"><label class="label">Ville</label>
                        <div class="input-wrapper"><Input v-model="form.city" required /></div>
                    </div>
                    <div class="col"><label class="label">NPA</label>
                        <div class="input-wrapper"><Input v-model="form.zip" required /></div>
                    </div>
                </div>
            </div>

            <div class="section">
                <h3 class="text-h4 text-neutral-800 mb-4">À propos</h3>
                <textarea v-model="form.about" class="textarea-field"
